...
## Program Name:              tsfae06b.R
## R version:                 4.2.1
## junco Version:             1.0
## Short Description:         Program to create tsfae06b: AE table by PT - TEAEs≥[x]% in Drug-Treated Group and
##                            ≥[y]% More Often in Drug-Treated Group Than Placebo-Treated Group
...
################################################################################
colwidth <- c(59, 21, 21, 21, 19, 30, 29)
